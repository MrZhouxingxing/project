<template>
     <div class="foot-btn" >
    <ul>
      <router-link to='/home' active-class="footerStyle"></router-link>
      <li class="home"><router-link to='/home' active-class="footerStyle"></router-link></a></li>
      <li class="write"><a href="javascript:;"></a></li>
      <li class="my"><router-link to='/user' active-class="footerStyle"></router-link></li>
    </ul>
  </div>
</template>
<style scoped>
